 ...
 * Under a blanket Bash(shgd:*) rule that is a pre-approved fetch-and-execute of
...
function assertFallowInstalled(): void {
  ...
  throw new Error('fallow is not installed in this repository, and shgd will not let npx download it. Run `npm install --save-dev fallow` first.');
}
